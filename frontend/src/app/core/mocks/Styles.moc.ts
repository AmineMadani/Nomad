export const aep_vanne_images:string[]=['AEP_VANNE_FERMEE_ELECTRO','AEP_VANNE_FERMEE_ROBINET','AEP_VANNE_FERMEE_TOUR','AEP_VANNE_OUVERT_ELECTRO','AEP_VANNE_OUVERT_ROBINET','AEP_VANNE_OUVERT_TOUR'];
