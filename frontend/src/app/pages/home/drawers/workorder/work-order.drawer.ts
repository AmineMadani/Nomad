...
import { WkoCreationComponent } from './pages/wko-creation/wko-creation.component';
import { WkoViewComponent } from './pages/wko-view/wko-view.component';
import { SynthesisButton } from '../synthesis/synthesis.drawer';
...
export class WorkOrderDrawer implements OnInit, OnDestroy {
  ...
  public wkoViews: QueryList<WkoViewComponent>;
