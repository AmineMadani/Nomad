...
public interface WorkorderRepository extends NomadRepository<Workorder, Long> {
	...
	List<TaskSearchDto> getTaskWithPaginationAndFilters(@Param("wtsIds") List<Long> wtsIds, @Param("wtrIds") List<Long> wtrIds, @Param("appointment") Boolean appointment, @Param("emergency") Boolean emergency, @Param("beginDate") Date beginDate, @Param("endDate") Date endDate, @Param("nbLimit") Long nbLimit, @Param("nbOffset") Long nbOffset, @Param("userId") Long userId);
}
