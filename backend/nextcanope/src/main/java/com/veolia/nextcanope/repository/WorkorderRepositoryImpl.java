...
public class WorkorderRepositoryImpl {
	...
	public List<TaskSearchDto> getWorkOrderPaginationWithCustomCriteria(
        ...
        return this.jdbcTemplate.query(
                "select distinct CAST(t.id AS text) as id, wko_name, wko_creation_cell, wko_creation_comment, wko_emergency, wko_appointment, wko_address, wko_street_number, wko_planning_start_date, wko_planning_end_date, wko_completion_start_date, wko_completion_end_date, wko_realization_user, wko_realization_cell, wko_realization_comment, cty_id, cty_llabel, w.wts_id, str_id, str_llabel, wko_ucre_id, wko_umod_id, wko_dmod, wko_dcre, wko_ddel, w.id as wko_id, t.longitude, t.latitude, wko_agent_nb " +
