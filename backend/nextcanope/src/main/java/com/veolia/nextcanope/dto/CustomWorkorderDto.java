...
public class CustomWorkorderDto {
	...
	public List<CustomTaskDto> getTasks() {
		return tasks;
	}

	public void setTasks(List<CustomTaskDto> tasks) {
		this.tasks = tasks;
	}
	...
	public CustomWorkorderDto(Workorder workorder) {
        ...
        this.tasks = new ArrayList<CustomTaskDto>();
        
        for(Task task: workorder.getListOfTask()) {
        	this.tasks.add(new CustomTaskDto(task));
        }
    }
}
