...
@Entity
@Table(name = "v_detailed_layer_tree", schema = "config")
public class VDetailedLayerTree implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private VDetailedLayerTreeId id;

	public VDetailedLayerTree() {
	}

	public VDetailedLayerTree(VDetailedLayerTreeId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({ @AttributeOverride(name = "parentDomainType", column = @Column(name = "parent_domain_type")),
			...
			@AttributeOverride(name = "parentTreeGroup", column = @Column(name = "parent_tree_group")),
	...
	public VDetailedLayerTreeId getId() {
		return this.id;
	}

	public void setId(VDetailedLayerTreeId id) {
		this.id = id;
	}
