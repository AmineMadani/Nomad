...
@Embeddable
public class VDetailedLayerTreeId implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private String parentDomainType;
	private String parentDomainAlias;
	private String parentTreeGroup;
	...
	public VDetailedLayerTreeId() {
	}

	public VDetailedLayerTreeId(String parentDomainType, String parentDomainAlias, String parentTreeGroup,
			String treeGroup, Integer id, Integer numOrder, String domainType, String businessObjectType,
			Integer treeGroupId, Integer simplifiedTreeGroupId, Serializable pgTable, String geomColumnName,
		...
		this.parentTreeGroup = parentTreeGroup;
	...
	@Column(name = "parent_tree_group")
	public String getParentTreeGroup() {
		return this.parentTreeGroup;
	}

	public void setParentTreeGroup(String parentTreeGroup) {
		this.parentTreeGroup = parentTreeGroup;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDetailedLayerTreeId))
			return false;
		VDetailedLayerTreeId castOther = (VDetailedLayerTreeId) other;
		...
		return ((this.getParentDomainType() == castOther.getParentDomainType())
				...
				&& ((this.getParentTreeGroup() == castOther.getParentTreeGroup())
						|| (this.getParentTreeGroup() != null && castOther.getParentTreeGroup() != null
								&& this.getParentTreeGroup().equals(castOther.getParentTreeGroup())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getParentTreeGroup() == null ? 0 : this.getParentTreeGroup().hashCode());
