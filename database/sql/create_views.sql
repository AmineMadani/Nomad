...
select t1.ast_code, t1.ast_slabel, t1.ast_llabel, replace(lyr_table_name, 'asset.', '') as lyr_table_name, wtr.wtr_slabel, wtr.wtr_llabel, wtr.wtr_code, t2.*
