...
-- aep_branche
update nomad.layer set lyr_style ='[{"id":"layer-aep_branche","type":"line","source":"aep_branche","minzoom":10,"layout":{"line-cap":"round","line-join":"round","visibility":"visible"},"paint":{"line-width":["case",["==",["get","ecoulement"],"Refoulement"],4,["==",["get","ecoulement"],"Surpressé"],3,3],"line-color":["case",["!=",["get","exploitant"],"Veolia"],"#000000",["coalesce",["get","cde_rvb"],"#00A1FF"]],"line-dasharray":["literal",[3,2]]},"filter":["!=",["get","ecoulement"],"Gravitaire"]},{"id":"aep_branche_style_2","type":"line","source":"aep_branche","minzoom":10,"layout":{"line-cap":"round","line-join":"round","visibility":"visible"},"paint":{"line-width":["case",["boolean",["feature-state","selected"],false],6,["boolean",["feature-state","hover"],false],8,["==",["get","ecoulement"],"Refoulement"],4,["==",["get","ecoulement"],"Surpressé"],3,3],"line-color":["case",["boolean",["feature-state","selected"],false],"#FFC0CB",["!=",["get","exploitant"],"Veolia"],"#000000",["coalesce",["get","cde_rvb"],"#00A1FF"]],"line-dasharray":["literal",[1,2]]},"filter":["==","$type","LineString"]},{"id":"aep_branche_style_3","type":"symbol","source":"aep_branche","minzoom":16,"layout":{"text-size":12,"text-allow-overlap":true,"symbol-spacing":159,"symbol-placement":"line","text-rotation-alignment":"map","text-anchor":"top","text-pitch-alignment":"map","text-field":["to-string",["get","id"]]},"paint":{"text-color":["case",["boolean",["feature-state","selected"],false],"#FFC0CB",["!=",["get","exploitant"],"Veolia"],"#000000",["coalesce",["get","cde_rvb"],"#00A1FF"]],"text-halo-width":10,"text-halo-color":"hsla(0, 0%, 96%, 0)"}}]'
where 	lyr_table_name = 'asset.aep_branche';

-- aep_canalisation
update nomad.layer set lyr_style ='[{"id":"layer-aep_canalisation","type":"line","source":"aep_canalisation","minzoom":10,"layout":{"line-cap":"round","line-join":"round","visibility":"visible"},"paint":{"line-width":["case",["==",["get","ecoulement"],"Refoulement"],4,["==",["get","ecoulement"],"Surpressé"],3,3],"line-color":["case",["!=",["get","exploitant"],"Veolia"],"#000000",["coalesce",["get","cde_rvb"],"#00A1FF"]],"line-dasharray":["literal",[3,2]]},"filter":["!=",["get","ecoulement"],"Gravitaire"]},{"id":"aep_canalisation_style_2","type":"line","source":"aep_canalisation","minzoom":10,"layout":{"line-cap":"round","line-join":"round","visibility":"visible"},"paint":{"line-width":["case",["boolean",["feature-state","selected"],false],6,["boolean",["feature-state","hover"],false],8,["==",["get","ecoulement"],"Refoulement"],4,["==",["get","ecoulement"],"Surpressé"],3,3],"line-color":["case",["boolean",["feature-state","selected"],false],"#FFC0CB",["!=",["get","exploitant"],"Veolia"],"#000000",["coalesce",["get","cde_rvb"],"#00A1FF"]],"line-dasharray":["literal",[1,2]]},"filter":["==","$type","LineString"]},{"id":"aep_canalisation_style_3","type":"symbol","source":"aep_canalisation","minzoom":16,"layout":{"text-size":12,"text-allow-overlap":true,"symbol-spacing":159,"symbol-placement":"line","text-rotation-alignment":"map","text-anchor":"top","text-pitch-alignment":"map","text-field":["to-string",["get","id"]]},"paint":{"text-color":["case",["boolean",["feature-state","selected"],false],"#FFC0CB",["!=",["get","exploitant"],"Veolia"],"#000000",["coalesce",["get","cde_rvb"],"#00A1FF"]],"text-halo-width":10,"text-halo-color":"hsla(0, 0%, 96%, 0)"}}]'
where 	lyr_table_name = 'asset.aep_canalisation';



-- aep_vanne
update nomad.layer set lyr_style ='[{"id":"aep_vanne_fermee_robinet_style","type":"symbol","source":"aep_vanne","minzoom":14,"filter":["all",["==",["get","position"],"Fermé"],["==",["get","type"],"Robinet/Opercule"]],"layout":{"visibility":"none","icon-allow-overlap":true,"icon-image":"AEP_VANNE_FERMEE_ROBINET","icon-rotate":["+",["get","angle"],90],"icon-rotation-alignment":"map","icon-ignore-placement":true,"symbol-spacing":10,"icon-size":0.2,"symbol-sort-key":1}},{"id":"aep_vanne_fermee_tour_style","type":"symbol","source":"aep_vanne","minzoom":14,"filter":["all",["==",["get","position"],"Fermé"],["==",["get","type"],"1/4 de tour"]],"layout":{"visibility":"none","icon-allow-overlap":true,"icon-image":"AEP_VANNE_FERMEE_TOUR","icon-rotate":["+",["get","angle"],90],"icon-rotation-alignment":"map","icon-ignore-placement":true,"symbol-spacing":10,"icon-size":0.5,"symbol-sort-key":1}},{"id":"aep_vanne_fermee_electro_style","type":"symbol","source":"aep_vanne","minzoom":14,"filter":["all",["==",["get","position"],"Fermé"],["==",["get","type"],"Electrovanne"]],"layout":{"visibility":"none","icon-allow-overlap":true,"icon-image":"AEP_VANNE_FERMEE_ELECTRO","icon-rotate":["+",["get","angle"],90],"icon-rotation-alignment":"map","icon-ignore-placement":true,"symbol-spacing":10,"icon-size":0.5,"symbol-sort-key":1}},{"id":"aep_vanne_ouvert_robinet_style","type":"symbol","source":"aep_vanne","minzoom":14,"filter":["all",["==",["get","position"],"Ouvert"],["==",["get","type"],"Robinet/Opercule"]],"layout":{"visibility":"none","icon-allow-overlap":true,"icon-image":"AEP_VANNE_OUVERT_ROBINET","icon-rotate":["+",["get","angle"],90],"icon-rotation-alignment":"map","icon-ignore-placement":true,"symbol-spacing":10,"icon-size":0.5,"symbol-sort-key":2}},{"id":"aep_vanne_ouvert_tour_style","type":"symbol","source":"aep_vanne","minzoom":14,"filter":["all",["==",["get","position"],"Ouvert"],["==",["get","type"],"1/4 de tour"]],"layout":{"visibility":"none","icon-allow-overlap":true,"icon-image":"AEP_VANNE_OUVERT_TOUR","icon-rotate":["+",["get","angle"],90],"icon-rotation-alignment":"map","icon-ignore-placement":true,"symbol-spacing":10,"icon-size":0.5,"symbol-sort-key":1}},{"id":"aep_vanne_ouvert_electro_style","type":"symbol","source":"aep_vanne","minzoom":14,"filter":["all",["==",["get","position"],"Ouvert"],["==",["get","type"],"Electrovanne"]],"layout":{"visibility":"none","icon-allow-overlap":true,"icon-image":"AEP_VANNE_OUVERT_ELECTRO","icon-rotate":["+",["get","angle"],90],"icon-rotation-alignment":"map","icon-ignore-placement":true,"symbol-spacing":10,"icon-size":0.5,"symbol-sort-key":1}}]' where 	lyr_table_name = 'asset.aep_vanne';


--asset.aep_ouvrage
update nomad.layer set lyr_style ='[{"id":"layer-aep_ouvrage","type":"symbol","source":"aep_ouvrage","minzoom":10,"layout":{"icon-image":["match",["get","type"],["Réservoir (sur tour)"],"AEP_RESERVOIR_TOUR",["Réservoir (semi enterré)"],"RESERVOIR_SEMI",["Station pompage","Station de reprise"],"STATION",["Usine de traitement"],"AEP_USINE_TRAITEMENT",""]},"paint":{}}]'
where 	lyr_table_name ='asset.aep_ouvrage';


 
--asset.aep_equipement
update nomad.layer set lyr_style ='[{"id":"layer-aep_equipement","type":"circle","source":"aep_equipement","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(57, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_equipement';


-- asset.aep_vanne_de_branche
update nomad.layer set lyr_style ='[{"id":"layer.aep_vanne_de_branche","type":"circle","source":"aep_vanne_de_branche","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(60, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_vanne_de_branche';


--asset.aep_compteur
update nomad.layer set lyr_style ='[{"id":"layer.aep_compteur","type":"circle","source":"aep_compteur","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(65, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_compteur';

--asset.aep_regulation
update nomad.layer set lyr_style ='[{"id":"layer.aep_regulation","type":"circle","source":"aep_regulation","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(67, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_regulation';

--asset.aep_purge
update nomad.layer set lyr_style ='[{"id":"layer.aep_purge","type":"circle","source":"aep_purge","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(70, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_purge';

-- asset.aep_equipement_public
update nomad.layer set lyr_style ='[{"id":"layer.aep_equipement_public_purge","type":"circle","source":"aep_equipement_public","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(73, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_equipement_public';

--asset.aep_defense_incendie
update nomad.layer set lyr_style ='[{"id":"layer.aep_defense_incendie","type":"circle","source":"aep_defense_incendie","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(76, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
where 	lyr_table_name ='asset.aep_defense_incendie';


-- asset.aep_point_desserte
update nomad.layer set lyr_style ='[{"id":"layer.aep_point_desserte","type":"circle","source":"aep_point_desserte","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(79, 59%, 79%)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
...
update nomad.layer set lyr_style ='[{"id":"layer.ass_equipement","type":"circle","source":"ass_equipement","minzoom":10,"layout":{},"paint":{"circle-radius":["case",["boolean",["feature-state","selected"],false],20,["boolean",["feature-state","hover"],false],12,7.5],"circle-color":"hsl(345, 20%, 20)","circle-blur":0.1,"circle-opacity":["case",["boolean",["feature-state","selected"],false],1,["boolean",["feature-state","hover"],false],1,0.7]}}]'
