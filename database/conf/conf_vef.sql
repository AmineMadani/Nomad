...
values
  ...
  ( 'dw' , 'dw_facility'       , 102, 102, 'patrimony.aep_ouvrage', 'geom', 'uuid', '2154', 'Ouvrage')
, ( 'dw' , 'dw_equipment'      , 103, 103, 'patrimony.aep_equipement', 'geom', 'uuid', '2154', 'Equipement')
, ( 'dw' , 'dw_valve'          , 103, 103, 'patrimony.aep_vanne', 'geom', 'uuid', '2154', 'Vanne')
, ( 'dw' , 'dw_water_meter'    , 103, 103, 'patrimony.aep_compteur', 'geom', 'uuid', '2154', 'Compteur')
, ( 'dw' , 'dw_regulation'     , 103, 103, 'patrimony.aep_regulation', 'geom', 'uuid', '2154', 'Regulateur')
, ( 'dw' , 'dw_purge'          , 103, 103, 'patrimony.aep_purge', 'geom', 'uuid', '2154', 'Purge/Vidange')
, ( 'dw' , 'dw_public_eqpt'    , 103, 103, 'patrimony.aep_equipement_public', 'geom', 'uuid', '2154', 'Equipement public')
, ( 'dw' , 'dw_lateral_line'   , 104, 104, 'patrimony.aep_branche', 'geom', 'uuid', '2154', 'Branchement')
, ( 'dw' , 'dw_pipe'           , 100, 105, 'patrimony.aep_canalisation', 'geom', 'uuid', '2154', 'Canalisation')
, ( 'dw' , 'dw_abandoned_pipe' , 100, 105, 'patrimony.aep_canalisation_abandonnee', 'geom', 'uuid', '2154', 'Canalisation abandonnée')
----
, ( 'ww' , 'ww_facility'       , 202, 202, 'patrimony.ass_ouvrage', 'geom', 'uuid', '2154', 'Ouvrage')
, ( 'ww' , 'ww_equipment'      , 203, 203, 'patrimony.ass_equipement', 'geom', 'uuid', '2154', 'Equipement')
, ( 'ww' , 'ww_connection'     , 203, 203, 'patrimony.ass_boite_de_branchement', 'geom', 'uuid', '2154', 'Boite de branchement')
, ( 'ww' , 'ww_intake'         , 203, 203, 'patrimony.ass_avaloir', 'geom', 'uuid', '2154', 'Avaloir / Grille')
, ( 'ww' , 'ww_manhole'        , 200, 203, 'patrimony.ass_regard', 'geom', 'uuid', '2154', 'Regard')
, ( 'ww' , 'ww_lateral_line'   , 204, 204, 'patrimony.ass_branche', 'geom', 'uuid', '2154', 'Branchement')
, ( 'ww' , 'ww_pipe'           , 200, 205, 'patrimony.ass_collecteur', 'geom', 'uuid', '2154', 'Collecteur')
, ( 'ww' , 'ww_abandoned_pipe' , 200, 205, 'patrimony.ass_canalisation_abandonnee', 'geom', 'uuid', '2154', 'Collecteur Abandonné')
, ( 'ww' , 'ww_water_area'     , 200, 205, 'patrimony.ass_surface_hydraulique', 'geom', 'uuid', '2154', 'Cours d''eau / fossé')
, ( 'ww' , 'ww_drain'          , 200, 205, 'patrimony.ass_drain', 'geom', 'uuid', '2154', 'Drain')
, ( 'ww' , 'ww_fictive_pipe'   , 200, 205, 'patrimony.ass_canalisation_fictive', 'geom', 'uuid', '2154', 'Canalisation fictive')
---
;
